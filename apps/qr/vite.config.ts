 ...
 * why the variable is V2-specific. It is a separate module so it can be unit-tested against
 * fixture env directories rather than by running e2e mode against the real machine-local
 * secret.
 *
